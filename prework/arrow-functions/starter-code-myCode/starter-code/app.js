...
// It's refers to the local function (scope()).
// 2. What is "this" when joe.scopeArrow() is invoked?
// It refers to the the global function (Student()).
// 3. Explain why "this" is different when an arrow function is used.
// because when we use arrow function, (this) will be used for all the main function
